...
function SignUpForm({ 
  ...
  return (
    <div>
      <h2 className="modal-title" id="modal-title">Welcome to CaloriePro</h2>
      <p className="modal-description" id="modal-desc">Create an account to access all features</p>
